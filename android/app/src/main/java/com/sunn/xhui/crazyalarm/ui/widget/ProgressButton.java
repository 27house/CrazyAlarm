package com.sunn.xhui.crazyalarm.ui.widget;
...
public class ProgressButton extends View {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		this.backgroundColor = typedArray.getInteger(R.styleable.ProgressButton_btnbackground, Color.parseColor("#C6C6C6"));
		this.foreground = typedArray.getInteger(R.styleable.ProgressButton_btnforeground, Color.rgb(20, 131, 214));
		this.textColor = typedArray.getInteger(R.styleable.ProgressButton_btntextcolor, Color.WHITE);
		this.max = typedArray.getInteger(R.styleable.ProgressButton_btnmax, 100);
		this.progress = typedArray.getInteger(R.styleable.ProgressButton_btnprogress, 0);
		this.text = typedArray.getString(R.styleable.ProgressButton_btntext);
		this.textSize = typedArray.getDimension(R.styleable.ProgressButton_btntextSize, 20);
		typedArray.recycle();
	}
