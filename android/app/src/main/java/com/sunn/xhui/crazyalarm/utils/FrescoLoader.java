...
public class FrescoLoader {
     ...
     */
    FrescoLoader(FrescoBuilder frescoBuilder) {
...
//                .setOldController(mSimpleDraweeView.getController())
        ...
        mSimpleDraweeView.setHierarchy(builderM.setFadeDuration(frescoBuilder.mFadeDuration).build());
     ...
     * @param builderC
     */
    private void setViewPerformance(FrescoBuilder frescoBuilder, GenericDraweeHierarchyBuilder builderM, PipelineDraweeControllerBuilder builderC) {
...
//            builderM.setPlaceholderImage(ContextCompat.getDrawable(mContext, R.drawable.ic_account_circle_gray_48dp), ScalingUtils.ScaleType.CENTER);
        ...
        if (frescoBuilder.mProgressBarImage != null) {
            Drawable progressBarDrawable = new AutoRotateDrawable(frescoBuilder.mProgressBarImage, 800);
