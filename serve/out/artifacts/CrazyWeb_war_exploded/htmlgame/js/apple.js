...
var states = {
    ...
    created: function () {
        this.create = function () {
            ...
            // 目标分数
            var strScore = game.add.text(10, game.world.height * 1, '目标分数：0/' + successScore, {
                fontSize: '20px',
                fontWeight: 'bold',
                fill: '#ff0000'
            });
            strScore.anchor.setTo(0, 1);

            // 添加标题
            var title = game.add.text(game.world.centerX, game.world.height * 0.25, '疯狂接苹果', {
                fontSize: '40px',
                fontWeight: 'bold',
                fill: '#f2bb15'
            });
    ...
    play: function () {
        ...
        this.create = function () {
            ...
            title.anchor.setTo(0.5, 0.5);
             // 目标分数
            strScore = game.add.text(10, game.world.height * 1, '目标分数：0/' + successScore, {
                fontSize: '20px',
                fontWeight: 'bold',
                fill: '#ff0000'
            });
        ...
        function pickApple(man, apple) {
            if (apple.type === 'bomb') {
                ...
                score += point;
                title.text = score;
                strScore.text = '目标分数：' + score + '/' + successScore;
                // 清除苹果
                apple.kill();
                // 播放音效
                scoreMusic.play();
    ...
    over: function () {
        ...
        this.create = function () {
            ...
            // 添加文本
            var title = game.add.text(game.world.centerX, game.world.height * 0.25, tip, {
                fontSize: '40px',
                fontWeight: 'bold',
                fill: '#f2bb15'
            });
            ...
            if (score >= successScore) {
                var finish = game.add.text(game.world.centerX, game.world.height * 0.8, '点击结束响铃', {
                    fontSize: '20px',
                    fontWeight: 'bold',
                    fill: '#f2bb15'
                });
